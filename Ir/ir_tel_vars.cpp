#include "ir_tel_vars.h"

ir_tel_vars::ir_tel_vars(QObject *parent) : QObject(parent)
{
  ...
  this->RadioTransmitCarIdx = new ir_tel_var(this, "RadioTransmitCarIdx");
  //this->all_vars.push_back(this->RadioTransmitCarIdx);
  this->RadioTransmitRadioIdx = new ir_tel_var(this, "RadioTransmitRadioIdx");
  //this->all_vars.push_back(this->RadioTransmitRadioIdx);
  this->RadioTransmitFrequencyIdx = new ir_tel_var(this, "RadioTransmitFrequencyIdx");
  //this->all_vars.push_back(this->RadioTransmitFrequencyIdx);
  this->DisplayUnits = new ir_tel_var(this, "DisplayUnits");
  //this->all_vars.push_back(this->DisplayUnits);
  ...
  this->IsReplayPlaying = new ir_tel_var(this, "IsReplayPlaying");
  this->all_vars.push_back(this->IsReplayPlaying);
  this->ReplayFrameNum = new ir_tel_var(this, "ReplayFrameNum");
  this->all_vars.push_back(this->ReplayFrameNum);
  this->ReplayFrameNumEnd = new ir_tel_var(this, "ReplayFrameNumEnd");
  this->all_vars.push_back(this->ReplayFrameNumEnd);
  this->IsDiskLoggingEnabled = new ir_tel_var(this, "IsDiskLoggingEnabled");
  this->all_vars.push_back(this->IsDiskLoggingEnabled);
  this->IsDiskLoggingActive = new ir_tel_var(this, "IsDiskLoggingActive");
  this->all_vars.push_back(this->IsDiskLoggingActive);
  ...
  this->CarIdxLap = new ir_tel_var(this, "CarIdxLap");
  this->all_vars.push_back(this->CarIdxLap);
  this->CarIdxLapCompleted = new ir_tel_var(this, "CarIdxLapCompleted");
  this->all_vars.push_back(this->CarIdxLapCompleted);
  this->CarIdxLapDistPct = new ir_tel_var(this, "CarIdxLapDistPct");
  this->all_vars.push_back(this->CarIdxLapDistPct);
  this->CarIdxTrackSurface = new ir_tel_var(this, "CarIdxTrackSurface");
  this->all_vars.push_back(this->CarIdxTrackSurface);
  this->CarIdxTrackSurfaceMaterial = new ir_tel_var(this, "CarIdxTrackSurfaceMaterial");
  this->all_vars.push_back(this->CarIdxTrackSurfaceMaterial);
  this->CarIdxOnPitRoad = new ir_tel_var(this, "CarIdxOnPitRoad");
  this->all_vars.push_back(this->CarIdxOnPitRoad);
  this->CarIdxPosition = new ir_tel_var(this, "CarIdxPosition");
  this->all_vars.push_back(this->CarIdxPosition);
  this->CarIdxClassPosition = new ir_tel_var(this, "CarIdxClassPosition");
  this->all_vars.push_back(this->CarIdxClassPosition);
  this->CarIdxF2Time = new ir_tel_var(this, "CarIdxF2Time");
  this->all_vars.push_back(this->CarIdxF2Time);
  this->CarIdxEstTime = new ir_tel_var(this, "CarIdxEstTime");
  this->all_vars.push_back(this->CarIdxEstTime);
  this->CarIdxLastLapTime = new ir_tel_var(this, "CarIdxLastLapTime");
  this->all_vars.push_back(this->CarIdxLastLapTime);
  this->CarIdxBestLapTime = new ir_tel_var(this, "CarIdxBestLapTime");
  this->all_vars.push_back(this->CarIdxBestLapTime);
  this->CarIdxBestLapNum = new ir_tel_var(this, "CarIdxBestLapNum");
  this->all_vars.push_back(this->CarIdxBestLapNum);
  this->PaceMode = new ir_tel_var(this, "PaceMode");
  this->all_vars.push_back(this->PaceMode);
  this->CarIdxPaceLine = new ir_tel_var(this, "CarIdxPaceLine");
  this->all_vars.push_back(this->CarIdxPaceLine);
  this->CarIdxPaceRow = new ir_tel_var(this, "CarIdxPaceRow");
  this->all_vars.push_back(this->CarIdxPaceRow);
  this->CarIdxPaceFlags = new ir_tel_var(this, "CarIdxPaceFlags");
  this->all_vars.push_back(this->CarIdxPaceFlags);
  this->OnPitRoad = new ir_tel_var(this, "OnPitRoad");
  this->all_vars.push_back(this->OnPitRoad);
  this->CarIdxSteer = new ir_tel_var(this, "CarIdxSteer");
  //this->all_vars.push_back(this->CarIdxSteer);
  this->CarIdxRPM = new ir_tel_var(this, "CarIdxRPM");
  //this->all_vars.push_back(this->CarIdxRPM);
  this->CarIdxGear = new ir_tel_var(this, "CarIdxGear");
  //this->all_vars.push_back(this->CarIdxGear);
 ...
 // this->all_vars.push_back(this->SteeringWheelAngle);
  ...
  this->RaceLaps = new ir_tel_var(this, "RaceLaps");
  this->all_vars.push_back(this->RaceLaps);
  ...
  this->DCLapStatus = new ir_tel_var(this, "DCLapStatus");
  this->all_vars.push_back(this->DCLapStatus);
  this->DCDriversSoFar = new ir_tel_var(this, "DCDriversSoFar");
  this->all_vars.push_back(this->DCDriversSoFar);
  this->OkToReloadTextures = new ir_tel_var(this, "OkToReloadTextures");
  //this->all_vars.push_back(this->OkToReloadTextures);
  this->LoadNumTextures = new ir_tel_var(this, "LoadNumTextures");
  //this->all_vars.push_back(this->LoadNumTextures);
  this->CarLeftRight = new ir_tel_var(this, "CarLeftRight");
  this->all_vars.push_back(this->CarLeftRight);
  ...
  this->CamCarIdx = new ir_tel_var(this, "CamCarIdx");
  //this->all_vars.push_back(this->CamCarIdx);
  this->CamCameraNumber = new ir_tel_var(this, "CamCameraNumber");
  //this->all_vars.push_back(this->CamCameraNumber);
  this->CamGroupNumber = new ir_tel_var(this, "CamGroupNumber");
  //this->all_vars.push_back(this->CamGroupNumber);
  this->CamCameraState = new ir_tel_var(this, "CamCameraState");
  //this->all_vars.push_back(this->CamCameraState);
  this->IsOnTrackCar = new ir_tel_var(this, "IsOnTrackCar");
  this->all_vars.push_back(this->IsOnTrackCar);
  this->IsInGarage = new ir_tel_var(this, "IsInGarage");
  this->all_vars.push_back(this->IsInGarage);
  ...
  this->SteeringWheelPeakForceNm = new ir_tel_var(this, "SteeringWheelPeakForceNm");
  //this->all_vars.push_back(this->SteeringWheelPeakForceNm);
  ...
  this->CarIdxP2P_Status = new ir_tel_var(this, "CarIdxP2P_Status");
  this->all_vars.push_back(this->CarIdxP2P_Status);
  this->CarIdxP2P_Count = new ir_tel_var(this, "CarIdxP2P_Count");
  this->all_vars.push_back(this->CarIdxP2P_Count);
  this->ReplayPlaySpeed = new ir_tel_var(this, "ReplayPlaySpeed");
  //this->all_vars.push_back(this->ReplayPlaySpeed);
  this->ReplayPlaySlowMotion = new ir_tel_var(this, "ReplayPlaySlowMotion");
  //this->all_vars.push_back(this->ReplayPlaySlowMotion);
  this->ReplaySessionTime = new ir_tel_var(this, "ReplaySessionTime");
  //this->all_vars.push_back(this->ReplaySessionTime);
  this->ReplaySessionNum = new ir_tel_var(this, "ReplaySessionNum");
  //this->all_vars.push_back(this->ReplaySessionNum);
  ...
  this->SteeringWheelTorque_ST = new ir_tel_var(this, "SteeringWheelTorque_ST");
  //this->all_vars.push_back(this->SteeringWheelTorque_ST);
  this->SteeringWheelTorque = new ir_tel_var(this, "SteeringWheelTorque");
  //this->all_vars.push_back(this->SteeringWheelTorque);
  this->VelocityZ_ST = new ir_tel_var(this, "VelocityZ_ST");
  //this->all_vars.push_back(this->VelocityZ_ST);
  this->VelocityY_ST = new ir_tel_var(this, "VelocityY_ST");
  //this->all_vars.push_back(this->VelocityY_ST);
  this->VelocityX_ST = new ir_tel_var(this, "VelocityX_ST");
  //this->all_vars.push_back(this->VelocityX_ST);
  ...
  this->YawRate_ST = new ir_tel_var(this, "YawRate_ST");
  //this->all_vars.push_back(this->YawRate_ST);
  this->PitchRate_ST = new ir_tel_var(this, "PitchRate_ST");
  //this->all_vars.push_back(this->PitchRate_ST);
  this->RollRate_ST = new ir_tel_var(this, "RollRate_ST");
  //this->all_vars.push_back(this->RollRate_ST);
  ...
  this->VertAccel_ST = new ir_tel_var(this, "VertAccel_ST");
  //this->all_vars.push_back(this->VertAccel_ST);
  this->LatAccel_ST = new ir_tel_var(this, "LatAccel_ST");
  //this->all_vars.push_back(this->LatAccel_ST);
  this->LongAccel_ST = new ir_tel_var(this, "LongAccel_ST");
  //this->all_vars.push_back(this->LongAccel_ST);
  ...
  this->RRshockDefl_ST = new ir_tel_var(this, "RRshockDefl_ST");
  //this->all_vars.push_back(this->RRshockDefl_ST);
  this->RRshockVel = new ir_tel_var(this, "RRshockVel");
  //this->all_vars.push_back(this->RRshockVel);
  this->RRshockVel_ST = new ir_tel_var(this, "RRshockVel_ST");
  //this->all_vars.push_back(this->RRshockVel_ST);
  this->LRshockDefl = new ir_tel_var(this, "LRshockDefl");
  //this->all_vars.push_back(this->LRshockDefl);
  this->LRshockDefl_ST = new ir_tel_var(this, "LRshockDefl_ST");
  //this->all_vars.push_back(this->LRshockDefl_ST);
  this->LRshockVel = new ir_tel_var(this, "LRshockVel");
  //this->all_vars.push_back(this->LRshockVel);
  this->LRshockVel_ST = new ir_tel_var(this, "LRshockVel_ST");
  //this->all_vars.push_back(this->LRshockVel_ST);
  this->RFshockDefl = new ir_tel_var(this, "RFshockDefl");
  //this->all_vars.push_back(this->RFshockDefl);
  this->RFshockDefl_ST = new ir_tel_var(this, "RFshockDefl_ST");
  //this->all_vars.push_back(this->RFshockDefl_ST);
  this->RFshockVel = new ir_tel_var(this, "RFshockVel");
  //this->all_vars.push_back(this->RFshockVel);
  this->RFshockVel_ST = new ir_tel_var(this, "RFshockVel_ST");
  //this->all_vars.push_back(this->RFshockVel_ST);
  this->LFshockDefl = new ir_tel_var(this, "LFshockDefl");
  //this->all_vars.push_back(this->LFshockDefl);
  this->LFshockDefl_ST = new ir_tel_var(this, "LFshockDefl_ST");
  //this->all_vars.push_back(this->LFshockDefl_ST);
  this->LFshockVel = new ir_tel_var(this, "LFshockVel");
  //this->all_vars.push_back(this->LFshockVel);
  this->LFshockVel_ST = new ir_tel_var(this, "LFshockVel_ST");
  //this->all_vars.push_back(this->LFshockVel_ST);
